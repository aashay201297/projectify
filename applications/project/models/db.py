...
#db.post.project_id.requires = IS_IN_DB(db, db.project.id, '%(name_of_project)s')
#db.post.author.requires = IS_NOT_EMPTY()
#db.post.project_id.writeble = db.post.project_id.readable = False
